...
int img_process_getcolor(cv::Mat& source_Img)
{
	...
	//inRange(source_Img, Scalar(0, 120, 0, 0), Scalar(140, 255, 150, 255), source_Img); //bgr绿色
	//inRange(source_Img, Scalar(0, 0, 160, 0), Scalar(120, 120, 255, 255), source_Img); //bgr红色
	inRange(source_Img, Scalar(0, 200, 200, 0), Scalar(100, 255, 255, 255), source_Img); //bgr黄色
